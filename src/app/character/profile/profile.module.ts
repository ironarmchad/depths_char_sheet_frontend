...
@NgModule({
  declarations: [
    ...
    LoreComponent,
    StatsComponent,
    StatsPointBuyComponent,
    NaturalAbilitiesComponent,
    NaturalAbilitiesEditComponent,
    SuperAbilitiesComponent,
    SuperAbilitiesEditComponent,
    ItemComponent,
    ItemEditComponent,
    StatAbilityComponent,
    StatAbilityEditComponent,
    ShareComponent
  ],
  imports: [
    CommonModule,
